# CSS Vercel Data Accessor

A [Community Solid Server](https://github.com/CommunitySolidServer/CommunitySolidServer/) (CSS) data accessor to use Vercel Blob storage as backend.
